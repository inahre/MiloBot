"""
seq2seq_chatbot_test.py

This script loads a trained Seq2Seq chatbot model and allows for interactive conversation in the terminal.
Pass in a trained checkpoint via the --ckpt flag to start chatting.

Usage:
    python seq2seq_chatbot_test.py --ckpt ckpt/chatbot/500_checkpoint.pt (replace with desired checkpoint)
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt', type=str, default="Path to the saved model checkpoint (.pt)")
    parser.add_argument('--device', type=str, default='cpu')
    parser.add_argument('--attn_model', type=str, default='dot')
    parser.add_argument('--corpus_name', type=str, default='milo_bot')
